...
def get_parameters():
    ...
    # Path
    parser.add_argument('--image_path', type=str, default='/home/zzy/sngan_projection/datasets/dogs')
    parser.add_argument('--log_path', type=str, default='./result/logs')
    parser.add_argument('--model_save_path', type=str, default='./result/models')
    parser.add_argument('--sample_path', type=str, default='./result/samples')
    parser.add_argument('--attn_path', type=str, default='./result/attn')
